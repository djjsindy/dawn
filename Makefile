...
pkgdatadir = $(datadir)/dawn
pkgincludedir = $(includedir)/dawn
pkglibdir = $(libdir)/dawn
pkglibexecdir = $(libexecdir)/dawn
...
am__v_CCLD_1 = 
SOURCES = $(dawn_SOURCES)
DIST_SOURCES = $(dawn_SOURCES)
...
PACKAGE_NAME = dawn
PACKAGE_STRING = dawn 1.0
PACKAGE_TARNAME = dawn
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
...
top_builddir = .
top_srcdir = .
dawn_SOURCES = src/main.c src/thread.c src/thread.h src/network.h src/kqueue.c src/fdop.c src/list.h src/list.c src/connection.h src/item.h src/item.c src/hash.h src/hash.c src/protocol.c src/dy_char.h src/dy_char.c src/buffer.h src/buffer.c src/connection.c src/memory.c src/memory.h src/malloc.h src/malloc.c src/queue.h src/queue.c
dawn_CPPFLAGS = -I src/ 
all: config.h
...
dawn$(EXEEXT): $(dawn_OBJECTS) $(dawn_DEPENDENCIES) $(EXTRA_dawn_DEPENDENCIES) 
	@rm -f dawn$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(dawn_OBJECTS) $(dawn_LDADD) $(LIBS)
...
include ./$(DEPDIR)/dawn-list.Po
include ./$(DEPDIR)/dawn-main.Po
include ./$(DEPDIR)/dawn-malloc.Po
include ./$(DEPDIR)/dawn-memory.Po
...
dawn-main.o: src/main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-main.o -MD -MP -MF $(DEPDIR)/dawn-main.Tpo -c -o dawn-main.o `test -f 'src/main.c' || echo '$(srcdir)/'`src/main.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-main.Tpo $(DEPDIR)/dawn-main.Po
#	$(AM_V_CC)source='src/main.c' object='dawn-main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-main.o `test -f 'src/main.c' || echo '$(srcdir)/'`src/main.c

dawn-main.obj: src/main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-main.obj -MD -MP -MF $(DEPDIR)/dawn-main.Tpo -c -o dawn-main.obj `if test -f 'src/main.c'; then $(CYGPATH_W) 'src/main.c'; else $(CYGPATH_W) '$(srcdir)/src/main.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-main.Tpo $(DEPDIR)/dawn-main.Po
#	$(AM_V_CC)source='src/main.c' object='dawn-main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-main.obj `if test -f 'src/main.c'; then $(CYGPATH_W) 'src/main.c'; else $(CYGPATH_W) '$(srcdir)/src/main.c'; fi`

dawn-thread.o: src/thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-thread.o -MD -MP -MF $(DEPDIR)/dawn-thread.Tpo -c -o dawn-thread.o `test -f 'src/thread.c' || echo '$(srcdir)/'`src/thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-thread.Tpo $(DEPDIR)/dawn-thread.Po
#	$(AM_V_CC)source='src/thread.c' object='dawn-thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-thread.o `test -f 'src/thread.c' || echo '$(srcdir)/'`src/thread.c

dawn-thread.obj: src/thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-thread.obj -MD -MP -MF $(DEPDIR)/dawn-thread.Tpo -c -o dawn-thread.obj `if test -f 'src/thread.c'; then $(CYGPATH_W) 'src/thread.c'; else $(CYGPATH_W) '$(srcdir)/src/thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-thread.Tpo $(DEPDIR)/dawn-thread.Po
...
dawn-list.o: src/list.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-list.o -MD -MP -MF $(DEPDIR)/dawn-list.Tpo -c -o dawn-list.o `test -f 'src/list.c' || echo '$(srcdir)/'`src/list.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-list.Tpo $(DEPDIR)/dawn-list.Po
#	$(AM_V_CC)source='src/list.c' object='dawn-list.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-list.o `test -f 'src/list.c' || echo '$(srcdir)/'`src/list.c

dawn-list.obj: src/list.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-list.obj -MD -MP -MF $(DEPDIR)/dawn-list.Tpo -c -o dawn-list.obj `if test -f 'src/list.c'; then $(CYGPATH_W) 'src/list.c'; else $(CYGPATH_W) '$(srcdir)/src/list.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-list.Tpo $(DEPDIR)/dawn-list.Po
#	$(AM_V_CC)source='src/list.c' object='dawn-list.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-list.obj `if test -f 'src/list.c'; then $(CYGPATH_W) 'src/list.c'; else $(CYGPATH_W) '$(srcdir)/src/list.c'; fi`
...
dawn-memory.o: src/memory.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-memory.o -MD -MP -MF $(DEPDIR)/dawn-memory.Tpo -c -o dawn-memory.o `test -f 'src/memory.c' || echo '$(srcdir)/'`src/memory.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-memory.Tpo $(DEPDIR)/dawn-memory.Po
#	$(AM_V_CC)source='src/memory.c' object='dawn-memory.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-memory.o `test -f 'src/memory.c' || echo '$(srcdir)/'`src/memory.c

dawn-memory.obj: src/memory.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-memory.obj -MD -MP -MF $(DEPDIR)/dawn-memory.Tpo -c -o dawn-memory.obj `if test -f 'src/memory.c'; then $(CYGPATH_W) 'src/memory.c'; else $(CYGPATH_W) '$(srcdir)/src/memory.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-memory.Tpo $(DEPDIR)/dawn-memory.Po
#	$(AM_V_CC)source='src/memory.c' object='dawn-memory.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-memory.obj `if test -f 'src/memory.c'; then $(CYGPATH_W) 'src/memory.c'; else $(CYGPATH_W) '$(srcdir)/src/memory.c'; fi`

dawn-malloc.o: src/malloc.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-malloc.o -MD -MP -MF $(DEPDIR)/dawn-malloc.Tpo -c -o dawn-malloc.o `test -f 'src/malloc.c' || echo '$(srcdir)/'`src/malloc.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-malloc.Tpo $(DEPDIR)/dawn-malloc.Po
#	$(AM_V_CC)source='src/malloc.c' object='dawn-malloc.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-malloc.o `test -f 'src/malloc.c' || echo '$(srcdir)/'`src/malloc.c

dawn-malloc.obj: src/malloc.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-malloc.obj -MD -MP -MF $(DEPDIR)/dawn-malloc.Tpo -c -o dawn-malloc.obj `if test -f 'src/malloc.c'; then $(CYGPATH_W) 'src/malloc.c'; else $(CYGPATH_W) '$(srcdir)/src/malloc.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-malloc.Tpo $(DEPDIR)/dawn-malloc.Po
#	$(AM_V_CC)source='src/malloc.c' object='dawn-malloc.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-malloc.obj `if test -f 'src/malloc.c'; then $(CYGPATH_W) 'src/malloc.c'; else $(CYGPATH_W) '$(srcdir)/src/malloc.c'; fi`

dawn-queue.o: src/queue.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-queue.o -MD -MP -MF $(DEPDIR)/dawn-queue.Tpo -c -o dawn-queue.o `test -f 'src/queue.c' || echo '$(srcdir)/'`src/queue.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-queue.Tpo $(DEPDIR)/dawn-queue.Po
#	$(AM_V_CC)source='src/queue.c' object='dawn-queue.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o dawn-queue.o `test -f 'src/queue.c' || echo '$(srcdir)/'`src/queue.c

dawn-queue.obj: src/queue.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dawn_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT dawn-queue.obj -MD -MP -MF $(DEPDIR)/dawn-queue.Tpo -c -o dawn-queue.obj `if test -f 'src/queue.c'; then $(CYGPATH_W) 'src/queue.c'; else $(CYGPATH_W) '$(srcdir)/src/queue.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/dawn-queue.Tpo $(DEPDIR)/dawn-queue.Po
